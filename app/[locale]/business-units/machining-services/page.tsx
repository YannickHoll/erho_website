...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return locale === "de"
    ? {
        title: "ERHO Machining Services — CNC-Präzisionszerspanung",
        description:
          "ERHO Machining Services bietet CNC-Präzisionszerspanung — Drehen, Fräsen, Bohren und Schleifen — vom Rohling zum Fertigteil. Prototyp bis Serienfertigung.",
      }
    : {
        title: "ERHO Machining Services — CNC Precision Machining",
        description:
          "ERHO Machining Services delivers CNC precision machining — turning, milling, drilling and grinding — from blank to finished part. Prototype to series production.",
      };
}
...
const pageT = {
  de: {
    ...
    subtitle: "Vom Rohling zum Fertigteil.",
    heroBody:
    ...
    capabilitiesEye: "Verfahren",
    capabilitiesH2: "Zerspanungskompetenzen",
    capacityH2: "Kapazität & Abmessungen",
    materialsH2: "Werkstoffe, die wir zerspanen",
    qualityH2: "Qualität & Inspektion",
    combinedEye: "Kombiniertes Angebot",
    combinedTitle: "Kombiniert mit ERHO Heavy Industry für eine vollständig fertige Komponente aus einer Hand.",
    combinedBody:
    ...
    combinedLink: "Heavy Industry erkunden",
    ctaH2: "Senden Sie uns Ihre Zeichnung.",
    ctaBody:
  ...
  en: {
    ...
    subtitle: "From blank to finished part.",
    heroBody:
      "CNC precision machining of forgings, castings and bar stock to your exact drawing — finished components ready for your assembly line.",
    whatWeDoH2: "What we do",
    whatWeDoBody1:
      "ERHO Machining Services takes your forgings, castings or bar stock and machines them to your exact drawing and tolerance. We manage the full machining sequence — turning, milling, drilling and grinding — with in-house and partner machining capacity across Europe.",
    whatWeDoBody2:
      "We work from prototype to series production. Whether you need a single shaft machined to drawing or a scheduled series of gear blanks — we adapt the programme to your production rhythm.",
    capabilitiesEye: "Processes",
    capabilitiesH2: "Machining capabilities",
    capacityH2: "Capacity & dimensions",
    materialsH2: "Materials we machine",
    qualityH2: "Quality & inspection",
    combinedEye: "Combined offering",
    combinedTitle: "Combined with ERHO Heavy Industry for a fully finished component from a single source.",
    combinedBody:
      "Heavy Industry sources and delivers the forging or casting. Machining Services machines it to your exact drawing. One order, one quality system, one delivery.",
    combinedLink: "Explore Heavy Industry",
    ctaH2: "Send us your drawing.",
    ctaBody:
      "Upload a drawing or describe the component. We'll confirm feasibility and come back with a schedule.",
    ctaBtn: "Submit a drawing",
    capabilities: [
      {
        title: "CNC turning",
        body: "High-precision turning of shafts, discs, rings and cylinders. Diameters up to 2,500 mm, lengths up to 6 m. Alloy steels, stainless, duplex and Inconel.",
      },
      {
        title: "CNC milling",
        body: "Milling of complex profiles, flanges, housings and precision flat surfaces. 3-axis and 4-axis milling capacity for demanding geometries.",
      },
      {
        title: "Boring & grinding",
        body: "Internal and external boring for precision bores in housings and cylinders. Surface and cylindrical grinding for tight dimensional and surface finish requirements.",
      },
      {
        title: "Surface treatment",
        body: "Coordination of surface treatment operations including phosphating, painting, plating and hard chrome through qualified European partners.",
      },
    ],
    capacityRows: [
      ["Max. turning diameter", "2,500 mm"],
      ["Max. turning length", "6,000 mm"],
      ["Weight range", "1 kg – 30,000 kg"],
      ["Production type", "Prototype, small batch, series"],
      ["Dimensional tolerance", "Up to IT6 / IT7"],
      ["Surface finish", "Ra 0.8 – 3.2 µm"],
    ],
    materials: [
      "Alloy steels — 42CrMo4, 34CrNiMo6, 18CrNiMo7-6",
      "Stainless steel — 316L, 304L",
      "Duplex / Superduplex — 1.4462, 1.4410",
      "Nickel alloys — Inconel 625, Inconel 718",
      "Tool steels — H13, D2, M2",
      "Carbon steels — S355, C45",
    ],
    qualityItems: [
      "Full dimensional inspection report",
      "CMM inspection on request",
      "Drawing conformance confirmation",
...
export default async function MachiningServicesPage({ params }: Props) {
  const { locale } = await params;
    ...
    <>
      ...
      <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center gap-2 mb-4">
            <Link href={p("/business-units")} className="font-body text-xs text-white/35 hover:text-steel transition-colors duration-200">
              {t.buLabel}
            </Link>
          ...
          <p className="mt-2 font-body text-steel/80 text-lg italic">{t.subtitle}</p>
      ...
      <section className="bg-white py-20 lg:py-28" aria-labelledby="capabilities-heading">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <p className="font-mono text-steel text-[11px] tracking-[0.22em] uppercase mb-3">{t.capabilitiesEye}</p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-5">
            {t.capabilities.map(({ title, body }, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            <ScrollReveal>
              ...
              <div className="mt-5 bg-navy rounded-sm p-6">
                <ul className="space-y-3" role="list">
                  {t.capacityRows.map(([label, value]) => (
            ...
            <ScrollReveal delay={80}>
              <h2 className="font-display text-navy text-2xl font-semibold mb-2">{t.materialsH2}</h2>
              <div className="w-8 h-0.5 bg-steel mt-3" aria-hidden="true" />
      ...
      <section className="bg-navy/5 border border-steel/20 mx-6 lg:mx-8 rounded-sm mb-8 p-7 lg:p-10">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <p className="font-mono text-steel text-[10px] uppercase tracking-widest mb-2">{t.combinedEye}</p>
            ...
            <Link href={p("/business-units/heavy-industry")} className="inline-flex items-center gap-1.5 font-body text-sm font-medium text-steel hover:text-steel/80 transition-colors duration-200">
      ...
      <section className="bg-navy hero-texture py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <Link
              href={p("/contact")}
              className="mt-8 inline-flex items-center gap-2 px-7 py-3.5 bg-steel text-white font-body font-semibold text-sm rounded-sm hover:bg-steel/90 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-steel focus:ring-offset-2 focus:ring-offset-navy"
            >
